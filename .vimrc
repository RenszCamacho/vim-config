source $HOME/.config/nvim/nvim-general/plugins.vim
source $HOME/.config/nvim/nvim-general/maps.vim
source $HOME/.config/nvim/nvim-general/settings.vim
source $HOME/.config/nvim/nvim-general/configs.vim
